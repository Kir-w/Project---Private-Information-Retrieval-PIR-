...
class Paillier:
    ...
    def encrypt(self, message: int):
        ...
        n2 = self.n ** 2
        r = number.getRandomRange(1, self.n) # r taille du message
        while gmpy2.gcd(r, self.n) != 1: # r doit être premier avec n
...
# Test for 1.2.2 : Homomorphic property test: c1 * c2 mod n² should encrypt (m1 + m2)
message1 = 42
message2 = 58
print(f"m1: {message1}, m2: {message2}")
...
print(f"Decrypted result for c1 * c2 mod n² : {decrypted_sum}")
assert decrypted_sum == (message1 + message2), "Homomorphic test failed"
print("Test 1.2.2 : Homomorphic test passed for addition")
...
print("Test 1.2.3 : Homomorphic test passed for addition")
...
print("Test 1.2.4 : Homomorphic test passed for multiplication")
